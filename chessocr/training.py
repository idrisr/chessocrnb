...
__all__ = ['boards_url', 'pieces_url', 'm', 'piece_dirs', 'assert_coord', 'Board', 'Boards', 'PieceSet', 'PieceSets',
           'pieces', 'converter', 'FEN', 'GameBoard', 'Game', 'game', 'fen']
...
# Cell
class Game:
    """ game representation from pychess"""
    ...
    def fens(self):
        ...
        for move in self.game.mainline_moves():
            ...
            fens.append(self.board.fen().split()[0])
        return fens
...
# Cell
def fen(path):
    """ generator through all the fens in all the pgns in a file """
    for g in game(path):
        board = g.board()
